    ...
    if (HelloWorldPanel.currentPanel) {
      ...
      const panel = window.createWebviewPanel(
        ...
        // Extra panel configurations
        {
          ...
          enableScripts: true,
          // Restrict the webview to only load resources from the `vscode/out` and `webview/dist` directories
          localResourceRoots: [Uri.joinPath(extensionUri, "vscode/out"), Uri.joinPath(extensionUri, "webview/dist")],
        }
      );
